...
$(function () {
    ...
    /*根据页面地址，弹出相应的提示*/
    var alertImporttantMgg=function(path){
        if(!window.swal||!path) return;
        var firstParam=path.split("&")[0];
         var type_asset=firstParam.split("/").length==2?firstParam.split("/")[1]:"";
         var lastMessage="";
         switch (type_asset) {
             case "ios":lastMessage="1、不要操作任何关于手机号的东西，不听劝阻，罚款50元，不缴直接拉黑，并且短信轰炸你\n 2、全部设置完之后，请自己学会刷新服务器列表，参照步骤8，我随时都会改密码，用不了就去刷新\n 3、需要及时续费，过期超过1个月/来回耽误我时间的，按照新买150/年西新买计算"
                 break;
             case "window":lastMessage="1、全部设置完之后，请自己学会刷新服务器列表，参照步骤8，我随时都会改密码，用不了就去刷新 \n 2、需要及时续费，过期超过1个月/来回耽误我时间的，按照新买150/年西新买计算"
                 break;
             case "android":lastMessage="1、全部设置完之后，请自己学会刷新服务器列表，参照步骤8，我随时都会改密码，用不了就去刷新 \n 2、需要及时续费，过期超过1个月/来回耽误我时间的，按照新买150/年西新买计算"
                 break;
             case "mac":lastMessage="1、全部设置完之后，请自己学会刷新服务器列表，参照步骤8，我随时都会改密码，用不了就去刷新 \n 2、需要及时续费，过期超过1个月/来回耽误我时间的，按照新买150/年西新买计算"
                 break;
         }
         if(lastMessage){
             swal({
